                ...
                <div class="panel-body">
                    <div>
                        <div class="col-md-6">
                            ...
                            <a id="btn_del_award" class="btn btn-danger">
                                <i class="fa fa-trash-o fa-fw"></i> {{ trans('app.button.delete_multi') }}
                            </a>
                        </div>

                        <div class="col-md-6">
                            {!! Form::open(['url' => 'admin/awards', 'method' => 'GET']) !!}
                    ...
                    <div id="data_grid" class="dataTable_wrapper data_list">
                        @include('admin.partials.list_award', ['listAwards' => $listAwards])
                    </div>
                </div>
            </div>
        </div>
